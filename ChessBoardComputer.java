/*
    ...
    It also interacts with 2 Class"Start" when the "play" button get clicks as Player vs Computer mode.
...
public class ChessBoardComputer extends ChessBoard implements ActionListener{
    ...
    public ChessBoardComputer() {
        ...
        JOptionPane.showMessageDialog(ChessBoardComputer.this, "You can change BOARDSIZE on upper left! " +
                        "You will be assigned as Player1 or Player2 randomly! ","This is PlAYER vs COMPUTER mode",
                         JOptionPane.INFORMATION_MESSAGE);
        //Generate random boolean number determining which of the two input boxes is editable and which is not
