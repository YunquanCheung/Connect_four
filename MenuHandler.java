/*
	...
	It interacts with 3 classes.
		If you click "Instruction" then it turns to
		1."InstructionView" class that displays the instruction message.
		If you click "Player vs Player" then it turns to
		2. "ChessBoard" class that execute Player vs Player;
		If you click "Instruction" then it turns to
		3."ChessBoardComputer" class which executes Player vs Computer;"
